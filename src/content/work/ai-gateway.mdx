...
blurb: An AI gateway on top of AWS Bedrock and Azure OpenAI, with direct Anthropic API access for newer Claude models. Around 8 product teams route through it for model selection, automatic failover, and centralized cost tracking across Claude, GPT-4, Llama, and Titan.
stack:
  - AWS Bedrock
  - Azure OpenAI
  - Anthropic API
