...
- **The Substrate**: ${about.portfolio}/substrate (a live, shared multi-agent simulation of an AI platform — orchestrator, retrievers, eval judge, supervisor — that visitors watch and perturb)
